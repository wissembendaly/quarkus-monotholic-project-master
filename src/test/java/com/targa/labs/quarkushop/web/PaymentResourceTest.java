...
class PaymentResourceTest {
    ...
    void testFindAll() {
        get("/payments").then()
                                 //it shouldnt work role management .statusCode(UNAUTHORIZED.getStatusCode());
    ...
    void testFindAllWithUserRole() {
        given().when()
                ...
                .get("/payments")
                .then()
//it shouldnt work role management .statusCode(FORBIDDEN.getStatusCode());
                .statusCode(OK.getStatusCode());}
    ...
    void testDeleteWithUserRole() {
        ...
        given().when()
                ...
                .then()
//it shouldnt work role management .statusCode(FORBIDDEN.getStatusCode());
                .statusCode(OK.getStatusCode());given().when()
                .header(HttpHeaders.AUTHORIZATION, "Bearer " + ADMIN_BEARER_TOKEN)
                .delete("/payments/" + createdPaymentId)
                .then()
                .statusCode(NO_CONTENT.getStatusCode());
